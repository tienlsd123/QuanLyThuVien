...
public class Main2Fragment extends Fragment {
    // Main admin
    Button btn_tv, btn_tt, btn_sach, btn_tl, btn_pm, btn_dt, btn_tk;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_tt = view.findViewById(R.id.btn_thuThu);
        ...
        btn_tt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), QuanlyThuThuActivity.class);
